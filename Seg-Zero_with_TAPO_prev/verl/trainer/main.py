...
class Runner:
    ...
    def run(self, config: PPOConfig):
        ...
        reward_fn = CustomRewardManager.remote(
            tokenizer=tokenizer, num_examine=1, compute_reward=config.worker.reward.compute_reward
        )
        train_dataloader = create_dataloader(config.data, tokenizer, processor)
