...
if __name__ == "__main__":
    ...
    parser.add_argument("--json_log", default="/home/gaash/Tawheed/Reasoning/Ealuation_logs/evaluation_qwen_2_vl_instruct.json", help="Path to save JSON results file")
