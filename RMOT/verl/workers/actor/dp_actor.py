...
class DataParallelPPOActor(BasePPOActor):
    ...
    @torch.no_grad()
    def compute_aug_log_prob(self, data: DataProto) -> torch.Tensor:
        """
        Compute log probability using temporally corrupted videos (TAPO).
        Assumes pixel_values / image_grid_thw already correspond to aug_images.
        """
